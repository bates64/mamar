...
pub type Vector2D = euclid::Vector2D<f32, UnknownUnit>;
pub type Vector3D = euclid::Vector3D<f32, UnknownUnit>;
pub type Size2D = euclid::Size2D<f32, UnknownUnit>;
pub type Size3D = euclid::Size3D<f32, UnknownUnit>;
pub type Box2D = euclid::Box2D<f32, UnknownUnit>;
pub type Box3D = euclid::Box3D<f32, UnknownUnit>;
pub type Rect = euclid::Rect<f32, UnknownUnit>;
pub type Transform2D = euclid::Transform2D<f32, UnknownUnit, UnknownUnit>;
pub type Transform3D = euclid::Transform3D<f32, UnknownUnit, UnknownUnit>;
